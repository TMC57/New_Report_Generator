...
if uid:
    ...
    records = models.execute_kw(
        ...
        {'fields': ["id", "pricelist_id", "company_id", "currency_id", "product_tmpl_id", "base_pricelist_id", "display_name", "create_date", "price", "x_studio_id_webflow", "x_studio_reference_interne"], 'limit': 10}
    )
